...
def kirim_email(pengirim, penerima, subject, html_content):
    ...
    server.starttls()
    server.login(pengirim, 'tnlg jspa qwdf ojao')
...
<body>
    <div class="container">
        ...
        <p>Sistem emal otomatis memudahkan pengirim pesan secara efisien dan terjadwal</p>
...
pengirim = 'dhiyaullami09@gmail.com'
penerima = 'sadiyah.rpl@gmail.com'
subject = 'Muh.Dhiyaul Lami / 20'
html_content = html_template
kirim_email(pengirim, penerima, subject, html_content)
